...
from utils.overlay_clothes import fit_clothing_to_keypoints  # NEW IMPORT
import cv2
import numpy as np



# --- Extract Keypoints + Clean Image (no drawing) ---
...
clothing = load_image("assets/clothes/tank_top_navy.png")
